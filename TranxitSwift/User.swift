...
class User : NSObject, NSCoding, JSONSerializable {
    ...
    convenience
    override init(){
        self.init(id: nil, accessToken: nil, firstName : nil, lastName : nil, mobile : nil, email : nil, currency : nil, picture : nil, refreshToken : nil, walletBalance : nil, sos : nil, loginType : nil,dispatcherNumber : nil, isCardAllowed: false, isCashAllowed : true, measurement : "km", stripeKey : nil, country_code: nil, gender: nil)
    }
    ...
    func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(self.stripeKey, forKey: Keys.list.country_code)
        aCoder.encode(self.gender, forKey: Keys.list.gender)
    }
